...
<body>
    ...
    <div style="padding: 20px;">
        ...
        <button onclick="window.location.href='Adddoctor.php'">Add Row</button>
        <div id="addRowForm" style="display: none;">
            <form action="add_row.php" method="post">
                ...
                <input type="text" name="telephone" placeholder="Contact Information" required>
    ...
    <script>
        function updateRow(username) {
            ...
            window.location.href = 'Adminupdate.php?username=' + username;
        }
    </script>
</body>
</html>
